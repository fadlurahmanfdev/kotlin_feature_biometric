package com.fadlurahmanfdev.mark_biometric.internal
...
import com.fadlurahmanfdev.mark_biometric.internal.dependency.capability.DeviceCapabilityDataSource
import com.fadlurahmanfdev.mark_biometric.internal.dependency.crypto.CipherDataSource
import com.fadlurahmanfdev.mark_biometric.internal.dependency.crypto.SecretKeyDataSource
import com.fadlurahmanfdev.mark_biometric.internal.dependency.encoding.Base64DataSource
import com.fadlurahmanfdev.mark_biometric.internal.dependency.prompt.PromptDataSource
import com.fadlurahmanfdev.mark_biometric.internal.dependency.prompt.PromptRequest
import com.fadlurahmanfdev.mark_biometric.domain.enums.MarkAuthenticationType
import com.fadlurahmanfdev.mark_biometric.domain.enums.MarkAuthenticationStatus
...
internal class MarkAuthenticatorInternal(
    ...
    private fun dispatchAuthenticationError(
        ...
        callback: com.fadlurahmanfdev.mark_biometric.api.callback.MarkAuthenticationCallback,
    ) {
